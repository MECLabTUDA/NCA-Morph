...
# train.py --img-list /local/scratch/aranem/BMVC_2024/BMVC_2024_trained_models/TransMorph/train_list.txt 
#          --seg-list /local/scratch/aranem/BMVC_2024/BMVC_2024_trained_models/TransMorph/train_seg.txt
#          --model-dir /local/scratch/aranem/BMVC_2024/BMVC_2024_trained_models/TransMorph/transmorph_torch_250_110_111_112_113_ncc_ce
#          --load-model /local/scratch/aranem/BMVC_2024/BMVC_2024_trained_models/TransMorph/transmorph_torch_250_110_111_112_113_ncc_ce/0250.pt
#          --initial-epoch 10
#          --gpu 0
#          --epochs 250
#          --seg
...
for tasks in train_on:
    ...
    for task in tasks:
        ...
        img_list = f'/local/scratch/aranem/BMVC_2024/BMVC_2024_trained_models/list_files/{mappings[task]}/train_list.txt'
        seg_list = f'/local/scratch/aranem/BMVC_2024/BMVC_2024_trained_models/list_files/{mappings[task]}/train_seg.txt'
        # out_folder = f'/local/scratch/aranem/BMVC_2024/BMVC_2024_trained_models/TransMorph/transmorph_torch_{nr_epochs}_{built_ts}_ncc_ce_default'
        out_folder = f'/local/scratch/aranem/BMVC_2024/BMVC_2024_trained_models/TransMorph/transmorph_torch_{nr_epochs}_{built_ts}_ncc_ce_tiny'
        # out_folder = f'/local/scratch/aranem/BMVC_2024/BMVC_2024_trained_models/TransMorph/transmorph_torch_{nr_epochs}_{built_ts}_ncc_ce_small'
        # out_folder = f'/local/scratch/aranem/BMVC_2024/BMVC_2024_trained_models/TransMorph/transmorph_torch_{nr_epochs}_{built_ts}_ncc_ce_large'
