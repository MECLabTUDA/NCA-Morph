...
# train.py --img-list /local/scratch/aranem/MIDL_2024/MIDL_2024_trained_models/ViTVNet/train_list.txt 
#          --seg-list /local/scratch/aranem/MIDL_2024/MIDL_2024_trained_models/ViTVNet/train_seg.txt
#          --model-dir /local/scratch/aranem/MIDL_2024/MIDL_2024_trained_models/ViTVNet/vitvnet_torch_250_110_111_112_113_ncc_ce
#          --load-model /local/scratch/aranem/MIDL_2024/MIDL_2024_trained_models/ViTVNet/vitvnet_torch_250_110_111_112_113_ncc_ce/0250.pt
#          --initial-epoch 10
#          --gpu 0
#          --epochs 250
#          --seg
...
for tasks in train_on:
    ...
    for task in tasks:
        ...
        out_folder = f'/local/scratch/aranem/MIDL_2024/MIDL_2024_trained_models/ViTVNet/vitvnet_torch_{nr_epochs}_{built_ts}_ncc_ce'
