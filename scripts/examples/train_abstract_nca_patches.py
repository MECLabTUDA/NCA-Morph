...
# NCAMorph with patches 210, 211, 212
...
for tasks in train_on:
    ...
    for task in tasks:
        ...
        # out_folder = f'/media/aranem_locale/AR_subs_exps/BMVC_2024/BMVC_2024_trained_models/NCA_Morph/vxm_nca_torch_{nr_epochs}_{built_ts}_ncc_kernel_3_3_30'
        # out_folder = f'/media/aranem_locale/AR_subs_exps/BMVC_2024/BMVC_2024_trained_models/NCA_Morph/vxm_nca_torch_{nr_epochs}_{built_ts}_ncc_kernel_5_5_30'
        # out_folder = f'/media/aranem_locale/AR_subs_exps/BMVC_2024/BMVC_2024_trained_models/NCA_Morph/vxm_nca_torch_{nr_epochs}_{built_ts}_ncc_kernel_7_7_30'
        # out_folder = f'/media/aranem_locale/AR_subs_exps/BMVC_2024/BMVC_2024_trained_models/NCA_Morph/vxm_nca_torch_{nr_epochs}_{built_ts}_ncc_kernel_9_9_30'
        # out_folder = f'/media/aranem_locale/AR_subs_exps/BMVC_2024/BMVC_2024_trained_models/NCA_Morph/vxm_nca_torch_{nr_epochs}_{built_ts}_ncc_kernel_7_7_5'
        # out_folder = f'/media/aranem_locale/AR_subs_exps/BMVC_2024/BMVC_2024_trained_models/NCA_Morph/vxm_nca_torch_{nr_epochs}_{built_ts}_ncc_kernel_7_7_10'
        # out_folder = f'/media/aranem_locale/AR_subs_exps/BMVC_2024/BMVC_2024_trained_models/NCA_Morph/vxm_nca_torch_{nr_epochs}_{built_ts}_ncc_kernel_7_7_50'
        # out_folder = f'/media/aranem_locale/AR_subs_exps/BMVC_2024/BMVC_2024_trained_models/NCA_Morph/vxm_nca_torch_{nr_epochs}_{built_ts}_ncc_kernel_7_7_90'
        # out_folder = f'/media/aranem_locale/AR_subs_exps/BMVC_2024/BMVC_2024_trained_models/NCA_Morph/vxm_nca_torch_{nr_epochs}_{built_ts}_ncc_kernel_7_7_10_direct_flow'
        # out_folder = f'/media/aranem_locale/AR_subs_exps/BMVC_2024/BMVC_2024_trained_models/NCA_Morph/vxm_nca_torch_{nr_epochs}_{built_ts}_ncc_kernel_7_7_30_direct_flow'
