...
# train.py --img-list media/aranem_locale/AR_subs_exps/BMVC_2024/BMVC_2024_trained_models/VoxelMorph_rigid/train_list.txt 
#          --seg-list media/aranem_locale/AR_subs_exps/BMVC_2024/BMVC_2024_trained_models/VoxelMorph_rigid/train_seg.txt
#          --model-dir media/aranem_locale/AR_subs_exps/BMVC_2024/BMVC_2024_trained_models/VoxelMorph_rigid/vxm_torch_250_110_111_112_113_ncc_ce
#          --load-model media/aranem_locale/AR_subs_exps/BMVC_2024/BMVC_2024_trained_models/VoxelMorph_rigid/vxm_torch_250_110_111_112_113_ncc_ce/0250.pt
#          --initial-epoch 10
#          --gpu 0
#          --epochs 250
#          --seg
...
for tasks in train_on:
    ...
    for task in tasks:
        ...
        out_folder = f'/media/aranem_locale/AR_subs_exps/BMVC_2024/BMVC_2024_trained_models/UNet_VxM/unet_torch_{nr_epochs}_{built_ts}_ce'
